...
async function main() {
  ...
  const PRICE_WEI = ethers.utils.parseUnits('0.00025','ether')
  ...
  let crowdsale = await Crowdsale.deploy(token.address,PRICE_WEI,ethers.utils.parseUnits(MAX_SUPPLY,'ether'),ICO_START,ICO_END,FUNDRAISING_GOAL)
