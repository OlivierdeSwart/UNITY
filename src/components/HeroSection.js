...
const HeroSection = ({ setScrollPosition }) => {
    ...
    return (
        <section className="h-screen flex flex-col items-center justify-center bg-gradient-to-r from-gray-700 via-gray-900 to-black text-white relative" onClick={handleClick}>
